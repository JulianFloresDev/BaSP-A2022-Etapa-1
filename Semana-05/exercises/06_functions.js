...
function validNumberInteger(num1, num2) {
    if ((typeof num1 !== "number") || (typeof num2 !== "number")) {
        ...
        if (!validateInteger(num1)) {
            alert('Exercise six.\nItem d)\n\nThe first number is not integer\n\n' + num1);
...
console.log('Exercise 6, e) Valid one float number and one integer numbers', validateSum(10, 10.561356));
